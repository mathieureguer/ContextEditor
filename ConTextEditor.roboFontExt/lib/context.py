...
DEFAULTS = {
    "neighbor_color_light" : (.25, .60, .78, .8),
    "neighbor_color_dark"  : (.87, .32, .7, .8),
    "mask_color_light"     : (.6, .6, .75, .8),
    "mask_color_dark"      : (.67, .5, .5, .8),
    "edit_color_light"     : (0, .95, 1, .8),
    "edit_color_dark"      : (0.9, 0, 1, .8),
}
